                ...
                <#--<div class="wrapper">-->
                    <#--<div class="fn-flex-1">-->
                        ...
                        <#--<div class="metro-line fn-flex">-->
                            ...
                            <#--<div class="metro-item">-->
                            <#--<#if ADLabel != '' >-->
                                <#--&lt;#&ndash;<a class="preview" href="https://hacpai.com/article/1460083956075">&ndash;&gt;-->
                                    <#--&lt;#&ndash;<img src="${staticServePath}/emoji/graphics/heart.png" alt="${sponsorLabel}">&ndash;&gt;-->
                                    <#--&lt;#&ndash;<b>${adDeliveryLabel}</b>&ndash;&gt;-->
                                <#--&lt;#&ndash;</a>&ndash;&gt;-->
                            <#--<#else>-->
